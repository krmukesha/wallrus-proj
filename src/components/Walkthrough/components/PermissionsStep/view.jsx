...
return(
  ...
  <div className={classes.bigContainer}>
    {openPedastal && <Paper className={classes.paper}>
      <div className={classes.topInfo}>
        <div>
          ...
          <p className="p-t-b text-white font-circular">
                Please accept for this app to use the position sensors, as well as the camera and mic.
          </p>
        </div>
      </div>
      <div>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button  onClick={(e) => {
            handleClosemodal();handlePermissionsGranted(e);}} color="primary" autoFocus>
            Yes
          </Button>
        </DialogActions>
      </Dialog>
        ...
        <Grid item xs={12} className={classes.circularProgress}>
          {permissionsGranted ? (
            ...
            <Fade
              ...
              style={{
                transitionDelay: permissionsGranted === false ? "800ms" : "0ms",
    ...
    {openError && <Paper className={classes.paper}>
    <h2 className="text-white font-imperator font-size text-uppercase">
          Error
          </h2>
          <div className="line"></div>
